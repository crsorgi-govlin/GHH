   ...
   //--------------This is to Get Registration Unit on behalf of City Village
	...
	birthcityvillageregistrationunitChange: function(loaderUrl) {
        ...
        $('#birth_legal_bir_le_birth_cityvillage').change(function() {
			var state = $.trim($("#birth_legal_bir_le_birth_state option:selected").val());
			var disrtict = $.trim($("#birth_legal_bir_le_birth_district option:selected").val());
			var subdisrtict = $.trim($("#birth_legal_bir_le_birth_sub_district option:selected").val());
